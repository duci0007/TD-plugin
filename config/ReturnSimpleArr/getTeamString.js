...
const default_teamPath = `${process.cwd()}/plugins/TD-plugin/config/default_SimpleTeamArr.yaml`
const teamPath = `${process.cwd()}/plugins/TD-plugin/config/SimpleTeamArr.yaml`
